(function() {
  ...
  rewriteMeta = function(file, data) {
    var chunk1_offset, chunk2_offset, dirname, extname, magic, metadata_offset, new_chunk1_offset, new_chunk2_offset, new_metadata, reader, writer;
  ...
  replaceMetadata = function(reader, writer, data) {
    var hasNext, i, key, new_metadata, size, value, valueType;
    new_metadata = {};
    hasNext = reader.readInt32();
    while (hasNext === 1) {
      key = reader.readString();
